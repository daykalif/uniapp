	...
	<view class="nav">
		...
		<view v-if="isHome" class="headnav"
			...
			<view class="search" style="flex: 1;">
				<!-- navigator标签能实现页面的跳转等功能 -->
				<navigator url="../../pages/search/index" :style="'height:'+menu.height*2+
				'rpx;line-height:'+menu.height*2+
				'rpx;margin-top:'+(menu.top*2-status)+
				'rpx;margin-left:32rpx;margin-right:'+
				(menu.width*2+24)+'rpx;background:#f4f4f4;border-radius:200rpx;text-align:center'">
